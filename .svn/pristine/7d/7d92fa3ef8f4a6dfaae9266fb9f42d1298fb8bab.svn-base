...
<div class=" clearfix">
 ...
 <div>
<form id="myForm" action="<%=basePath%>discounts/updDiscounts" method="post"> 
<input name="disId" type="hidden" value="${discounts.disId }"  />
   <ul class="add_conent">
	    <li class=" clearfix">
	    	<label class="label_name"><i><font color="red">*</font></i>活动时间：</label>
	    	<input name="disTime" type="text" value="${discounts.disTime }" class="add_text" datatype="*" nullmsg="不能为空" />天
	    </li>
	    <li class=" clearfix">
	    	<label class="label_name"><i><font color="red">*</font></i>优惠金额：</label>
	    	<input name="disMoney" value="${discounts.disMoney }" type="text" class="add_text" datatype="*" nullmsg="不能为空" />元
	    </li>
	    <li>

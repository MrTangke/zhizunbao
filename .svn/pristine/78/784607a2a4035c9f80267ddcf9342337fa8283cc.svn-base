        ...
        <div class="main_width list_new">
            ...
            <div class="list_con fix">
                ...
                <c:forEach items="${insureList }" var="ins">
		            ...
		            <img style="position:absolute; left:78%; top:8%;" src="<%=basePath%>${ins.imgSrc}" alt="暂无图片">
	                    <!--<input type="hidden" class="imgurl">-->
	                    <h2>
	                        <a href="<%=basePath %>frontInsure/findInsureByInsureIdFree?insureId=${ins.insureId}">&nbsp;&nbsp;${ins.insureName }</a>
	                    ...
	                    <p>
	                        <a href="<%=basePath %>frontInsure/findInsureByInsureIdFree?insureId=${ins.insureId}" class="custom">评价：${ins.commentCount }条</a>
	                        <span class="saled">售出：${ins.insureNumber }份</span>
	                    </p>
	                    <a href="<%=basePath %>frontInsure/findInsureByInsureIdFree?insureId=${ins.insureId}" class="btn">查看详情</a>
	                    <a href="<%=basePath %>frontInsure/findInsureByInsureIdFree?insureId=${ins.insureId}" class="a_link"></a>
	                </div>
                </c:forEach>
           	 </div>
          </div>

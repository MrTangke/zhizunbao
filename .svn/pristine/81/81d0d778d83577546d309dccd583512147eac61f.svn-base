...
<div class="margin clearfix">
 <div class="article_style">
    ...
    <input name="readId" value="${userRead.readId }" type="hidden" />
     <ul>
      <li class="clearfix Mandatory">
      <label class="label_name"><i>*</i>活动标题</label><span class="formControls col-10"><input erro="活动标题" value="${userRead.readTitle }"  name="readTitle" type="text" id="form-field-1" class="col-xs-10 col-sm-5 "></span>
      </li>
     
      <li class="clearfix"><label class="label_name"><i>*</i>排序</label><span class="formControls col-10"><input erro="排序" value="${userRead.readOrder }" type="text" name="readOrder" id="form-field-1" class="col-xs-10 col-sm-1"></span></li>
    
      <li class="clearfix"><label class="label_name"><i>*</i>活动内容</label>
      <span class="formControls col-10"><script id="editor" value="${userRead.readContent }" name="readContent" erro="文章内容" type="text/plain" style="width:100%;height:400px; margin-left:10px;">${userRead.readContent }</script>
      </li>
     </ul>
     ...
     $(".Mandatory input[type$='text']").each(function(n){
          if($(this).val()=="")
          {
		    ...
		    return false;
        	  ...
        	  var url = "<%=basePath %>userRead/updUserRead";

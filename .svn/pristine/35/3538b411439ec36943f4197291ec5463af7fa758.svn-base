  ...
  <div class="administrator">
    ...
    <!--操作-->
     <div class="border clearfix">
       <span class="l_f">
        <a href="<%=basePath %>discounts/toAddDiscounts" id="administrator_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加活动</a>
       </span>
     ...
     <div class="margin clearfix">
		...
		<div class="compete_list">
			<table id="sample-table-1"
				...
				<c:forEach items="${discountsList}" var="dis">
					<tbody>
						<tr>
							<td>${dis.disTime}天
							</td>
							<td>${dis.disMoney}元</td>
							<td>
							<a title="编辑活动" onclick="member_edit('活动的修改','<%=basePath %>discounts/toUpdDiscounts','${dis.disId}','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>       
                            <a title="删除活动" href="javascript:;"  onclick="member_del(this,'${dis.disId}')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                            </td>
						</tr>
				</c:forEach>
				</tbody>

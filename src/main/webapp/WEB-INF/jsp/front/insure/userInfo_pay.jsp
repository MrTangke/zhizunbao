...
<div class="wrapper">
    ...
    <!----------------------------------------header_nav end-------------------------------------->
     <div class="paybox_main">
        <div class="titlebox">
            <span class="fr">支付金额：<em>${insure.insurePrice-userDiscounts.userMoney }元</em></span>
...
/* 	var i =$("li[class$='on']").map(function(){
	...
	var money=${insure.insurePrice-userDiscounts.userMoney};
	var id=${userDiscounts.id};
	if(payType==null || payType==""){
		...
		//alert(payType+"  "+insureId+" "+money);
			location = "<%=basePath%>frontBuy/pay?pd_FrpId="+payType+"&insureId="+insureId+"&insurePrice="+money+"&id="+id;
	}
}
</script>
</html>
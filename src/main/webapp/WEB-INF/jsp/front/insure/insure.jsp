        ...
        <div class="detail_first main_width fix">
            ...
            <div class="first_right fl">
                ...
                <div class="submit_box">
                    <a href="<%=basePath %>frontBuy/toBuyOne?insureId=${insure.insureId}"  class="submit_buy">立即购买</a>已售<em>${insure.insureNumber }</em>份
                </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	function fenye(page){
		...
		location = "<%=basePath%>frontInsure/findInsureByInsureId?insureId="+insureId+"&currentPage="+page;
	}
</script>
</body>
</html>
    ...
    <div class="floor_main">
        ...
        <div class="scroll_box" id="focus_map">
            ...
            <c:forEach items="${imglists }" var="imgs">
            	     <li><a href="<%-- <%=basePath %>${imgs.jumpUrl} --%>"><img src="<%=basePath %>${imgs.imgUrl}" alt=""></a></li>
          	</c:forEach>
            </ul>
                    ...
                    <c:forEach items="${baoxainImg }" var="bimg">
                        <li>
                            ...
                            <div class="baise">
                                ...
                                <a href="<%=basePath %>activit/${bimg.jumpUrl}?imgOrder=${bimg.imgOrder }" class="up_bao"></a>
                                <div class="zhe_text">
                                ...
                                <span class="num">
                                    ...
                                    <a href="<%=basePath %>activit/particulars" class="check">查看详情</a>
                                </div>
                            </div>
                        </li>
                        </c:forEach>

...
<div class=" clearfix">
 ...
 <div>
<form id="myForm" action="<%=basePath%>insure/addSafeGuard" method="post"> 
   <ul class="add_conent">
	    <li class=" clearfix">
	    	<label class="label_name"><i><font color="red">*</font></i>保障项目：</label>
	    	<input name="safeguardProject" type="text" class="add_text" datatype="*" nullmsg="不能为空" />
	    </li>
	    <li class=" clearfix">
	    	<label class="label_name"><i><font color="red">*</font></i>保障金额：</label>
	    	<input name="safeguardMoney" type="text" class="add_text" datatype="*" nullmsg="不能为空" />
	    </li>
	    <li class=" clearfix">
		    <label class="label_name"><i><font color="red">*</font></i>保险范围：</label> 
		    <textarea name="safeguardScope" cols="" rows="" class="textarea" onkeyup="checkLength(this);" datatype="*" nullmsg="不能为空" ></textarea>

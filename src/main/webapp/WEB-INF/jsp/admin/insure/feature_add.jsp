...
<div class=" clearfix">
 ...
 <div>
<form id="myForm" action="<%=basePath%>insure/addFeature" method="post"> 
   <ul class="add_conent">
	    <li class=" clearfix">
		    <label class="label_name"><i><font color="red">*</font></i>特色简介：</label> 
		    <textarea name="featureContent" cols="" rows="" class="textarea" onkeyup="checkLength(this);" datatype="*" nullmsg="不能为空" ></textarea>

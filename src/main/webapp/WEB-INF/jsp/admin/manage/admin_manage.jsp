...
<div class="page-content clearfix">
  <div class="administrator">
    ...
    <!--操作-->
     <div class="border clearfix">
      ...
      <div   id="testIframe">
           <table class="table table-striped table-bordered table-hover" style="width: 100%;" id="sample_table">
		<thead>
		 <tr>
	...
	<tbody>
     ...
     <tr>
      ...
      <td class="td-status"><span class="label label-success radius">${manageList.manageStatus==0 ? '已启用':'已停用' }</span></td>
      <td class="td-manage">
       ...
       <c:if test="${sessionScope.man.roleId==1 }">
       <a title="初始化密码" onclick="resetPassword(this,'${manageList.password }','${manageList.manageId}','${manageList.username }')" href="javascript:;"  class="btn btn-xs btn-success" ><i class="fa fa-refresh"></i></a> 
 ...
 <!--添加管理员-->
 <div id="add_administrator_style" class="add_menber" style="display:none" enctype="multipart/form-data">
    <form action="<%=basePath %>manage/toManageAdd" method="post" id="Form">
        
		<div class="form-group">
			<label class="form-label"><span class="c-red">*</span>名字：</label>
			<div class="formControls">
				<input type="text" class="input-text" value="" placeholder="名字" id="user-name" name="realName" datatype="*2-16" nullmsg="用户名不能为空">
			</div>
		...
		<div class="form-group">
			...
			<div class="formControls">
				<input type="text" class="input-text" value="" placeholder="登陆名" id="user-name" name="username" datatype="*2-16" nullmsg="登陆名不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="formControls ">
		  <input class="inline laydate-icon input-text" placeholder="生日" id="start" style="width: 250px;" name="manageBirthday" nullmsg="生日不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="formControls ">
				<input type="text" class="input-text" value="" placeholder="手机" id="user-tel" name="manageTel" datatype="m" nullmsg="手机号不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
			...
			<div class="formControls ">
				<input type="text" class="input-text" value="" placeholder="身份证" id="user-tel" name="manageCard" datatype="m" nullmsg="身份证不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
			...
			<div class="formControls ">
				<input type="text" class="input-text" placeholder="@" name="manageEmail" id="email" datatype="e" nullmsg="邮箱不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<c:if test="${sessionScope.man.roleId==1 }">
...
//初始化密码
function resetPassword(url,password,manageId,username){
	layer.confirm("确定要初始化姓名为  <span style='color:red'>【" + username + "】</span>  人员的密码为000000吗?",function(index){
		var url = "<%=basePath %>manage/toResetPassword";
		var params = {};
		params.manageId = manageId;

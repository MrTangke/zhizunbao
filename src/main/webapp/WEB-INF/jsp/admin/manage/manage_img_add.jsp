...
<body>
  <article class="page-container">
	<form style="width:650px" action="<%=basePath%>manage/uploadImg" class="form form-horizontal" id="Form" method="post"  enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>登录名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="manageName" value="${manage.username}" size="50" datatype="*"  placeholder="请输入管理员名字" />
				<input type="hidden" class="input-text" name="manageId" value="${manage.manageId }" size="50" datatype="*"  placeholder="请输入登录名" />
			</div>
		</div>
		<div class="row cl">
     ...
     $(function(){
     	...
     	$("#Form").submit(function(){	
     		...
     		if(filePath!=""&&filePath!=null){
     			...
     			layer.msg('请上传头像！',{icon:1,time:1000});
     			return false;
     		};
     	})
     	$("#Form").Validform({
